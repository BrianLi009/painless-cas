...
# ==========================
.PHONY: minisat glucose lingeling kissat kissat_mab kissat_inc yalsat cadical maple m4ri maples

solvers: minisat glucose lingeling kissat kissat_mab kissat_inc yalsat cadical maple maples
